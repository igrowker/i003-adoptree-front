...
import { ArbolData } from '../AdoptarArbol/AdoptarArbol';

const AdoptarEsteArbol: React.FC = () => {
  
  const [arbol, setArbol] = useState<ArbolData>();
        ...
        <div className="md:flex">
          ...
          <div className="p-8 md:w-1/2">
            ...
            <p className="mt-2 text-gray-500">
              Gracias a: {`${arbol.finca.productor.nombre} ${arbol.finca.productor.apellido}`}
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              >
                <Link className='flex items-center justify-center' to={`/adopta-un-arbol`}><ArrowLeft className="mr-2 h-5 w-5" /> Volver</Link>
              </button>
            </div>
          </div>
        </div>
