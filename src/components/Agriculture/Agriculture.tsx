...
const Agriculture: React.FC<AgricultureProps> = ({ language }) => {
  const content: Record<'es' | 'en', ContentText> = {
    es: {
      ...
      regenerate:
        'Regeneramos el suelo, cuidamos los insectos y optimizamos el uso de agua y energía.',
    ...
    en: {
      ...
      regenerate:
        'We regenerate the soil, care for insects, and optimize the use of water and energy.',
  ...
  return (
    <section className="flex lg:px-[200px] 2xl:px-[130px] mt-[220px] mb-[6em] max-lg:flex-col max-lg:items-center 4xl:justify-center">
      ...
      <section className="w-[50%] 4xl:w-[30%] max-lg:w-[100%] max-lg:ml-16 max-lg:mt-16">
        ...
        <h2 className="text-[#1F1E17] lg:text-[2.6rem] leading-none 2xl:text-5xl font-[800] w-[70%] lg:mb-[1rem] 2xl:mb-8 max-lg:w-[100%]">
          {title}
        </h2>
        <h3 className="text-[#4BAF47] lg:text-[1.16rem] 2xl:text-xl font-bold lg:mb-[1rem] 2xl:mb-[1.2rem]">
          {subtitle}
        </h3>
        <p className="text-[#878680] lg:text-[.9rem] 2xl:text-base lg:w-[90%] lg:mb-[1rem] 2xl:mb-[1.2rem] max-lg:w-[90%] max-lg:mb-8">
          {description}
        </p>
        <div className="mb-[1.2rem] flex items-center max-lg:mb-8 gap-[15px]">
          <div className="flex items-center w-[30%] gap-[10px]">
            <img
              className="lg:w-[50px] 2xl:w-[64px]"
              src={FruitIcon}
              alt="Fruit Icon"
            />
            <p className="text-[#1F1E17] lg:text-[.9rem] 2xl:text-base font-bold">
              {buyFruit}
            </p>
          </div>
          <div className="flex items-center w-[30%] gap-[10px]">
        ...
        <div className="mb-[1.2rem] max-lg:mb-8 w-[90%]">
          <div className="flex">
            ...
            <p className="text-[#1F1E17] font-semibold lg:text-[.9rem] 2xl:text-base">
              {ecological}
            </p>
          </div>
          <div className="flex">
